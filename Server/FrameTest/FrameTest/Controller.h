...
#ifndef __FrameTest__Controller__
#define __FrameTest__Controller__
...
private:
    ...
    typedef void (*OnChangedControlValuesCallback)(const ControlValues* const);
    enum TYPE { // 데이터 타입.
        TYPE_CONNECT = 'k', // 연결
        TYPE_MSG = 'm', // 메세지
...
#endif /* defined(__FrameTest__Controller__) */
